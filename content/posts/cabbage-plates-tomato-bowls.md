---
title: >-
  Cabbage Plates & Tomato Bowls: The Veggie Ceramics Taking Over Summer Tables
  (2026)
description: >-
  The best cabbage leaf plates and tomato-shaped bowls of 2026 — sculpted green
  stoneware, heirloom tomato pinch bowls and lidded dip bowls for a whimsical,
  garden-fresh summer table.
category: scalloped-dinnerware
date: '2026-07-12'
cover: /thumbnails/thumb-cabbage-plates-tomato-bowls.webp
products:
  - name: 'Le Jardin Green Cabbage 9 in Salad/Dessert Plates, Set of 4'
    image: 'https://m.media-amazon.com/images/I/71vioqXjVbL._AC_SL1500_.jpg'
    brand: Le Jardin
    price: ~$35-45
    retailer: Amazon
    badge: Best overall
    blurb: >-
      Deeply sculpted stoneware leaves in a fresh garden green — the classic
      lettuce-ware look without the vintage-market price. The 9 in size is the
      one you'll actually reach for: salads, cake slices, sandwiches,
      everything.
    caveat: >-
  ...
  - name: 'Le Jardin Green Cabbage 11 in Dinner Plates, Set of 4'
    ...
    price: ~$50-60
    retailer: Amazon
    badge: Best dinner plates
    blurb: >-
      Full-size dinner plates in the same sculpted leaf pattern, so you can set
      an entire veggie-ware table rather than just accent it. Substantial
      stoneware with a glossy, hand-dipped-looking glaze.
    caveat: >-
  ...
  - name: 'KXZ Green Ceramic Cabbage Plates, 8 in, Set of 4'
    ...
    badge: Budget pick
    blurb: >-
      The most-reviewed cabbage plates on this list — microwave and dishwasher
      safe, a slightly lighter build, and a leaf texture that photographs
      beautifully for the price.
    caveat: >-
  ...
  - name: Le Jardin Cabbage 13 in Round Serving Platter
    ...
    price: ~$25-35
    retailer: Amazon
    badge: Best serving piece
    blurb: >-
      One big sculpted cabbage leaf that makes a caprese board or fruit spread
      look styled with zero effort. The cheapest way to get the look on your
      table — one statement piece instead of a whole set.
    caveat: >-
  ...
  - name: 'Now Designs Heirloom Tomatoes Pinch Bowls, Set of 6'
    ...
    price: ~$28-35
    retailer: Amazon
    badge: Best tomato bowls
    blurb: >-
      Six little stoneware tomatoes in mixed heirloom shades — red, blush, gold
      and green — that corral olives, flaky salt, dips and jam. The easiest,
      most giftable entry into tomato-girl tableware.
    caveat: >-
  ...
  - name: Mud Pie Fiesta Tomato Dip Bowl Set with Spoon
    ...
    badge: Best under $25
    blurb: >-
      A cheerful lidded tomato bowl with its own little serving spoon — salsa,
...
faqs:
  - q: Is cabbage ware the same as lettuce ware?
    a: >-
      They're cousins. "Lettuce ware" usually refers to the famous mid-century
      Dodie Thayer style — pale, tightly ruffled leaves — while modern "cabbage
      ware" tends to be deeper green with broader sculpted veining. Stores use
      the terms almost interchangeably now; what matters is sculpted dimension
      and a hand-glazed look.
  - q: Are sculpted cabbage plates practical for everyday meals?
    a: >-
      Yes, with one caveat: the dimensional rim means slightly less flat surface
      than a plain plate of the same size, and they stack taller in a cabinet.
      For salads, pasta, sandwiches and desserts they're completely functional —
      this isn't display-only china.
  - q: 'Do tomato bowls actually get used, or are they just cute?'
    a: >-
      The pinch-bowl size earns its keep fast — salt and pepper by the stove,
...
Cabbage ware has a real pedigree: sculpted lettuce and cabbage ceramics have been a status tableware since the 18th century, and hand-thrown versions still sell for hundreds of dollars a plate. What changed in the last couple of years is availability — stoneware makers now produce genuinely lovely sculpted-leaf pieces at normal-dinnerware prices, right as the "tomato girl summer" aesthetic (Mediterranean tables, market produce, red-and-green palettes) took over summer hosting content. The result is a look that feels collected and slightly eccentric, but costs less than a plain white dinner set from a department store.
