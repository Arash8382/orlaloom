...
products:
  ...
  - name: "Maison d'Hermine 100% Cotton Kitchen Tea Towels, Set of 3"
    ...
    caveat: "These are the display-and-dry kind, thinner than a terry workhorse towel — that's the point, but heavy-mess cooks will still keep their old rags."
  ...
  - name: "Pure Beeswax Pillar Candles, Unscented, Pack of 6"
    ...
    retailer: "Amazon"
    badge: "Coziest glow"
    blurb: "Six honey-colored 100% beeswax pillars with a faint natural honey scent and roughly 32 hours of burn time each. Beeswax is the cottagecore candle: no added fragrance to clash with dinner, a warmer flame than paraffin, and a material story you can tell as you hand it over. Gift two or three tied with twine and keep the rest — a consumable gift never becomes clutter, which is exactly what you want when you don't know the host's taste."
    caveat: "Unscented by design — if the recipient expects a perfumed jar candle, this is a different, quieter kind of luxury."
  ...
  - name: "CypherX Vintage Wooden Recipe Box with 50 Cards & 8 Dividers"
    ...
    blurb: "A stained wooden recipe box with blank 4x6 cards and wooden dividers — the rare housewarming gift that gets more valuable the longer it's owned. Slip one family recipe onto the first card before you wrap it and the gift is finished; the host fills in the rest over years. It sits on a counter looking like it was inherited, and for a couple in a new home it lands somewhere between practical and heirloom."
    caveat: "It's an analog gift — best for hosts who cook and love a bit of ritual, wasted on the strictly-takeout household."
  ...
  - name: "Ceramic Flower Trinket Dish, Hand-Painted Pink"
    ...
    blurb: "A palm-sized ceramic dish shaped like an open flower, made for rings by the sink, keys by the door, or a teabag by the kettle. This is the gift for the smaller occasions — a casual dinner, a thank-you, a 'saw this and thought of you' — where a full serving board would feel like too much. It's the kind of object that ends up used daily precisely because it's small, pretty, and asks nothing."
    caveat: "It's genuinely little — check the dimensions so you're not expecting a catch-all bowl."
