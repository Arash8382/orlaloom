...
products:
  - name: "BEBE BASK Scalloped Wicker Wall Basket (16 x 10 in)"
    ...
    blurb: "The scalloped edge is what makes this one feel cottagecore rather than generic boho — a single hand-woven basket that reads as real wall art over a bed or sofa."
  ...
  - name: "CHI AN HOME Jute Wall Decor Baskets, Set of 6 (10-23 in)"
    ...
    blurb: "Six graduated jute plates in one box — the easy way to build a balanced cluster without hunting down matching pieces. Warm, flat, and easy to arrange."
    caveat: "Flat woven plates, not deep baskets, so they're for looks rather than holding anything."
  ...
  - name: "7-Pack Seagrass Rattan Round Wall Decor"
    ...
    retailer: "Amazon"
    badge: "Best value"
    blurb: "Seven flat seagrass rounds for the price of one fancy basket — the cheapest way to fill a big empty wall with natural texture."
    caveat: "These are thin and lightweight; lovely massed together but a little plain on their own."
  ...
  - name: "CHI AN HOME Extra-Large Water Hyacinth Wall Baskets, Set of 3 (15-22 in)"
    ...
    blurb: "Three big water-hyacinth baskets in soft white that fill a tall, awkward wall fast — great over a staircase or a high-ceilinged living room."
    caveat: "The white finish is painted; handle gently and expect a natural, slightly uneven weave."
  ...
  - name: "Telsist 11-Piece Boho Woven Wall Basket Set"
    ...
    blurb: "Eleven baskets in mixed sizes and warm tones — enough to wrap a corner or cover a whole feature wall in one purchase, with variety built in."
    caveat: "Tones lean warm and a touch rustic; check the photos if you want a strictly neutral palette."
