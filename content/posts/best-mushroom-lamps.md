...
products:
  ...
  - name: "BOHON Ceramic Mushroom Lamp with Wood Base, Orange"
    ...
    retailer: "Amazon"
    badge: "Best overall"
    blurb: "The grown-up mushroom lamp: a glossy orange ceramic shade on a solid wood base, with a warm 2700K E12 bulb included. It reads retro-Scandinavian rather than novelty, holds a 4.8-star rating, and is substantial enough to anchor a nightstand."
    caveat: "The ceramic shade directs light down rather than glowing all over like glass — lovely and cozy, but pick a glass style if you want the whole cap to light up."
  ...
  - name: "HEQET Hand-Blown Orange Glass Mushroom Lamp"
    ...
    blurb: "A hand-blown glass cap that glows amber from rim to rim when lit — the closest thing to the vintage Murano mushroom lamps that fetch hundreds on resale sites. Takes a standard E27 bulb, so you can tune the warmth yourself."
    caveat: "Hand-blown glass means small bubbles and slight asymmetry piece to piece — character to most eyes, but not for perfectionists."
  ...
  - name: "Glivpny Mid-Century Glass Mushroom Table Lamp"
    ...
    blurb: "A minimalist take with a scalloped 'egg tart' glass shade that scatters soft ripples of light across the wall — more mid-century modern than woodland, which makes it the mushroom lamp for rooms that are only cottagecore-adjacent."
    caveat: "It sits on the small side for a large nightstand — measure before you buy if you want real presence rather than an accent."
  ...
  - name: "BOHON Ceramic Mushroom Lamp with Wood Base, Pink"
    ...
    blurb: "The same 4.8-star BOHON lamp in a soft blush pink — made for coquette-leaning bedrooms, dressing tables and anywhere a bow or ruffle already lives. The wood base keeps it from tipping into full dollhouse territory."
    caveat: "Pink is commitment: it is the piece the whole corner ends up styled around, so make sure your palette wants it."
