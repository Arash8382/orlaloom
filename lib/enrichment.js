...
export function galleryFor(product, enrichment) {
  ...
  // Enrichment first, static image last. Both often point at the SAME asset, and
  // the frontmatter copy is a smaller render (e.g. _AC_SX679_ vs _AC_SL1500_) — going
  // static-first meant the dedupe kept the low-res one and the hero looked soft.
