...
export const author = {
  ...
  // A verifiable identity strengthens the Person entity for Google E-E-A-T and AI
  // trust. These are the brand profiles the founder runs. Add a personal LinkedIn
  // + a real headshot URL (image) when available for the strongest signal.
